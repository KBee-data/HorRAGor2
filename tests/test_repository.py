...
def _seeded_engine(tmp_path):
    ...
    with engine.begin() as c:
        c.execute(text("create table movies (id integer primary key, tmdb_id integer, "
                       "title text, release_date text, overview text)"))
        ...
        c.execute(text("insert into movies values "
                       "(41,493,'Hereditary','2018-06-07','Une famille hantee...')"))
